/* speedie's dwm configuration file
/* Used with my slstatus config on Gentoo
/* Make sure to install fontawesome before compiling.
/* Then compile using "make clean install"
/* Have a good day!
